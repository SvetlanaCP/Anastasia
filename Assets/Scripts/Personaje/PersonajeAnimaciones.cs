...
public class PersonajeAnimaciones : MonoBehaviour
{
    ...
    private PersonajeMovimiento _personajeMovimiento; //referencia
    private PersonajeAtaque _personajeAtaque;  //referencia
    ...
    {//si estamos atacando
        ...
        {//activamos los layer de las animaciones de atacar
        ...
        {//si estamos quieto la pose de parado Idle
